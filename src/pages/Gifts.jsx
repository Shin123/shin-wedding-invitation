          ...
          >
            ...
            >
              ...
              <p className="text-gray-600 leading-relaxed">
                Món quà ý nghĩa nhất với vợ chồng mình là sự hiện diện của bạn
                trong ngày trọng đại này. Nếu bạn muốn gửi thêm lời chúc bằng
                quà mừng cưới, tụi mình xin được đón nhận với tất cả sự biết ơn
              ...
              <div className="bg-white p-6 rounded-2xl shadow-lg max-w-sm mx-auto">
                ...
                <div className="mt-6 text-center space-y-1">
                  ...
                  <p className="text-md text-gray-600 tracking-wide">
                    Số tài khoản:{' '}
                    <span className="font-medium">101882998878</span>
                  </p>
