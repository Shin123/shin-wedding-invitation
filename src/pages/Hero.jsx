...
export default function Hero() {
  ...
  return (
    <>
      <section
        id="home"
        className="min-h-screen flex flex-col items-center justify-center px-4 py-16 sm:py-20 text-center relative overflow-hidden bg-[url('/images/bg-edited.jpg')] bg-cover bg-center -translate-x"
      >
        <motion.div
        ...
        >
          <div className="space-y-4 mb-20">
            ...
            <motion.h2
              ...
              className="text-3xl sm:text-4xl font-serif bg-clip-text text-transparent bg-gradient-to-r from-rose-600 to-pink-600"
            >
          ...
          >
            ...
            <div className="relative px-4 sm:px-8 py-4 sm:py-10 rounded-2xl border border-rose-100/50">
              ...
              <div className="space-y-4 text-center">
                <div className="space-y-3">
                  ...
                  >
                    ...
                    <div className="gap-1 text-rose-500 font-semibold text-lg flex flex-row items-center justify-center">
                    ...
                    <p className="text-gray-600 font-medium text-sm">
                      của Văn Việt & Phụng Thư
                    </p>
                  </motion.div>
                </div>

                <div className="flex items-center justify-center gap-3">
                  <div className="h-px w-8 sm:w-12 bg-rose-500/50" />
